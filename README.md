...
It is optional and if you do not specify API keys, the agent will use a list of memories. 
This isn't as robust, but if you are trying to get up and running quickly you can skip it.
